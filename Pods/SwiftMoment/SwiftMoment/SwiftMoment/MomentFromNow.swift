...
extension Moment {
    ...
    public func fromNow() -> String {
        ...
        if deltaSeconds < 5 {
            ...
            // Seconds Ago
            return stringFromFormat("%%1.0f%@s", withValue: deltaSeconds)
            ...
            // Minutes Ago
            return stringFromFormat("%%1.0f%@m", withValue: deltaSeconds / minuteInSeconds)
        ...
        return stringFromFormat("%%1.0f%@yrs", withValue: value)
    }
